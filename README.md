...
<p>
ระบบโอเพ่นสแตคใช้ระบบฐานข้อมูลมาเรียดีบี mariadb [5] ซึ่งเป็นระบบฐานข้อมูลแบบโอเพ่นซอร์สที่โอเพ่นสแตคใช้เก็บข้อมูลเมตาดาต้า (metadata) ผู้ติดตั้งต้องรันสคริปต์ exe-stage04-SUDO-mysql.sh บนเครื่องคอนโทรเลอร์ ซึ่งสคริปต์จะทำหน้าที่ต่อไปนี้ 
<ul>
...
หลังจากเสร็จการรันสคริปต์แล้วให้ล็อกอินไปยังเครื่องเน็ตเวิร์ค 
<pre>
On controller: 
$ pwd

...
openstack user create --domain default --password vasabilabDEMO_PASS myuser
...
openstack --os-auth-url http://controller:5000/v3 \
  --os-project-domain-name default --os-user-domain-name default \
  --os-project-name myproject --os-username myuser --os-password vasabilabDEMO_PASS token issue

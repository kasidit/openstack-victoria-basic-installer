...
export END_FLOATING_IP=10.0.0.180
#
# ---- compute host ----
#
export COMPUTE_IP=10.0.0.11
export COMPUTE_IP_NIC=ens3
export DATA_TUNNEL_COMPUTE_NODE_IP=10.0.1.11
export DATA_TUNNEL_COMPUTE_NODE_IP_NIC=ens4
export VLAN_COMPUTE_NODE_IP_NIC=ens4
#
# ---- compute1 host ----
#
export COMPUTE1_IP=10.0.0.11
export COMPUTE1_IP_NIC=ens3
export DATA_TUNNEL_COMPUTE1_NODE_IP=10.0.1.11
export DATA_TUNNEL_COMPUTE1_NODE_IP_NIC=ens4
export VLAN_COMPUTE1_NODE_IP_NIC=ens4

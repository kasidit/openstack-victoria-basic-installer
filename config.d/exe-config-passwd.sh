...
export PLACEMENT_DBPASS=$(openssl rand -hex 10)
...
export OCTAVIA_DBPASS=$(openssl rand -hex 10)
export OCTAVIA_PASS=$(openssl rand -hex 10)
#
else
#
...
export ORIPLACEMENT_DBPASS=vasabilabPLACEMENT_DBPASS
...
export ORIOCTAVIA_DBPASS=vasabilabOCTAVIA_DBPASS
export ORIOCTAVIA_PASS=vasabilabOCTAVIA_PASS
#
...
# Change NOVA_PASS 
#
CHANGETOPIC=PLACEMENT_DBPASS
#
printf "\nsubstitution\n"

printf "\n----------\n"
grep -n "${ORIPLACEMENT_DBPASS}" ${ETC_FILES} | tee ./tmpfile ; wc -l ./tmpfile
printf "\n\n${CHANGETOPIC} (in etc files) changed to\n\n"
sed -i "s/${ORIPLACEMENT_DBPASS}/${PLACEMENT_DBPASS}/g" ${ETC_FILES}
grep -n "${PLACEMENT_DBPASS}"  ${ETC_FILES}  | tee ./tmpfile ; wc -l ./tmpfile 
#
printf "\nsubstitution\n"

printf "\n----------\n"
grep -n "${ORIPLACEMENT_DBPASS}" ${SCRIPT_FILES} | tee ./tmpfile ; wc -l ./tmpfile
printf "\n\n${CHANGETOPIC} changed to\n\n"
sed -i "s/${ORIPLACEMENT_DBPASS}/${PLACEMENT_DBPASS}/g" ${SCRIPT_FILES}
grep -n "${PLACEMENT_DBPASS}" ${SCRIPT_FILES}  | tee ./tmpfile ; wc -l ./tmpfile 
printf "\n----------\n"
#
# Change DASH_DBPASS 
#
...
#
#
# Change OCTAVIA_DBPASS 
#
CHANGETOPIC=OCTAVIA_DBPASS
#
printf "\nsubstitution\n"

printf "\n----------\n"
grep -n "${ORIOCTAVIA_DBPASS}" ${ETC_FILES} | tee ./tmpfile ; wc -l ./tmpfile
printf "\n\n${CHANGETOPIC} (in etc files) changed to\n\n"
sed -i "s/${ORIOCTAVIA_DBPASS}/${OCTAVIA_DBPASS}/g" ${ETC_FILES}
grep -n "${OCTAVIA_DBPASS}"  ${ETC_FILES}  | tee ./tmpfile ; wc -l ./tmpfile 
#
printf "\nsubstitution\n"

printf "\n----------\n"
grep -n "${ORIOCTAVIA_DBPASS}" ${SCRIPT_FILES} | tee ./tmpfile ; wc -l ./tmpfile
printf "\n\n${CHANGETOPIC} changed to\n\n"
sed -i "s/${ORIOCTAVIA_DBPASS}/${OCTAVIA_DBPASS}/g" ${SCRIPT_FILES}
grep -n "${OCTAVIA_DBPASS}" ${SCRIPT_FILES}  | tee ./tmpfile ; wc -l ./tmpfile 
printf "\n----------\n"
#
# Change OCTAVIA_PASS 
#
CHANGETOPIC=OCTAVIA_PASS
#
printf "\nsubstitution\n"

printf "\n----------\n"
grep -n "${ORIOCTAVIA_PASS}" ${ETC_FILES} | tee ./tmpfile ; wc -l ./tmpfile
printf "\n\n${CHANGETOPIC} (in etc files) changed to\n\n"
sed -i "s/${ORIOCTAVIA_PASS}/${OCTAVIA_PASS}/g" ${ETC_FILES}
grep -n "${OCTAVIA_PASS}"  ${ETC_FILES}  | tee ./tmpfile ; wc -l ./tmpfile 
#
printf "\nsubstitution\n"

printf "\n----------\n"
grep -n "${ORIOCTAVIA_PASS}" ${SCRIPT_FILES} | tee ./tmpfile ; wc -l ./tmpfile
printf "\n\n${CHANGETOPIC} changed to\n\n"
sed -i "s/${ORIOCTAVIA_PASS}/${OCTAVIA_PASS}/g" ${SCRIPT_FILES}
grep -n "${OCTAVIA_PASS}" ${SCRIPT_FILES}  | tee ./tmpfile ; wc -l ./tmpfile 
printf "\n----------\n"
#
